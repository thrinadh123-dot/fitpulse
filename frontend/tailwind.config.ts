	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				// WCAG Compliant Light Mode Colors
			...
			boxShadow: {
				...
				'inner-lg': 'inset 0 0 100px rgba(0, 0, 0, 0.3)',
			},
			...
			keyframes: {
				...
				'lightGlowPulse': {
					'0%, 100%': {
						boxShadow: '0 0 20px hsl(var(--sunset-orange) / 0.3)',
						transform: 'scale(1)'
					},
					'50%': {
						boxShadow: '0 0 40px hsl(var(--red-violet) / 0.6)',
						transform: 'scale(1.1)'
					}
				},
				'drawPath': {
			...
			animation: {
				...
				'switch-colors': 'switchColors 8s ease-in-out infinite',
				'light-glow-pulse': 'lightGlowPulse 4s ease-in-out infinite',
				'draw-path': 'drawPath 3s ease-in-out infinite',
